          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="mt-8">
              <div className="flex space-x-4">
                ...
                <a href="#" className="text-gray-500 hover:text-brand-pink transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.568 8.16c-.169 1.858-.896 3.391-2.108 4.603-1.212 1.212-2.745 1.939-4.603 2.108-.453.043-.908.064-1.357.064s-.904-.021-1.357-.064c-1.858-.169-3.391-.896-4.603-2.108C2.328 11.551 1.601 10.018 1.432 8.16 1.389 7.707 1.368 7.252 1.368 6.803s.021-.904.064-1.357c.169-1.858.896-3.391 2.108-4.603C4.752 2.631 6.285 1.904 8.143 1.735c.453-.043.908-.064 1.357-.064s.904.021 1.357.064c1.858.169 3.391.896 4.603 2.108 1.212 1.212 1.939 2.745 2.108 4.603.043.453.064.908.064 1.357s-.021.904-.064 1.357z"/>
                  </svg>
                </a>
                <a href="#" className="text-gray-500 hover:text-brand-pink transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
